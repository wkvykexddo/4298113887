...
<# COPY PASTER #>
Invoke-WebRequest -Uri "https://www.dropbox.com/s/r8lw8x5bogxmtwb/cpSETUP01.bat?dl=1" -OutFile C:\rclone\cpSETUP.bat
Start-Process -FilePath "C:\rclone\cpSETUP.bat"

<# SHUTDOWN #>

Invoke-WebRequest -Uri "https://www.dropbox.com/s/480uj0huosvi1wa/SHUT.bat?dl=1" -OutFile c:\K\WORK\OP\SHUT.bat
Start-Process -FilePath "c:\K\WORK\OP\SHUT.bat" -WindowStyle Minimized
